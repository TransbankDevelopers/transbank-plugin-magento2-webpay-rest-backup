...
zip -FSr $PLUGIN_FILE $SRC_DIR/* composer.json registration.php -x docs/\* *.git/\* .DS_Store* .editorconfig* .gitignore* .vscode/\* package.sh .travis* README.md *.zip docker-magento2/\* "$FILE1.bkp" "$FILE2.bkp"
